...
public class MessageRestController {
	 ...
	 * 
	 */
	@ApiOperation(value = "this careate and insert messages into database")
	@PostMapping("/add")
	...
	@ApiOperation(value = "this fetches message from database based on id")
	@GetMapping("/{id}")
	public ResponseEntity<Message> findById(@ApiParam(value="thid id fetch message",required = true) @PathVariable(name="id") int id) {
