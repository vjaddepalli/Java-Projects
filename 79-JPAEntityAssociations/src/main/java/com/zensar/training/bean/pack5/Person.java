...
public class Person {
	...
	@JoinTable(name = "persons3_contactinfo3", joinColumns = @JoinColumn(name = "person_id", referencedColumnName = "personId"), inverseJoinColumns = @JoinColumn(name = "contact_id", referencedColumnName = "contactId", unique = true))
