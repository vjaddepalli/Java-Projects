...
public class Employee {
	...
	public void setGrade(char grade) {
		...
		if (this.grade == 'B')
			this.salaryCalculator = new BGradeCalculator();
		if (this.grade == 'C')
			this.salaryCalculator = new CGradeCalculator();
	}

	@Override
	public String toString() {
		return "Employee [name=" + name + ", basicSalary=" + basicSalary + ", grade=" + grade + ", salaryCalculator="
				+ salaryCalculator + "]";
	}
